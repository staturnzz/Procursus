...
setup:
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /libsyscall/wrappers/{spawn/spawn{$(comma)_private}$(comma)libproc/libproc{$(comma)_internal$(comma)_private}}.h \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /libsyscall/wrappers/{spawn/spawn{$(comma)_private}$(comma)libproc/libproc{$(comma)_internal$(comma)_private}}.h \
		...
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /{EXTERNAL_HEADERS/mach-o/nlist$(comma)osfmk/mach/vm_statistics}.h \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /{EXTERNAL_HEADERS/mach-o/nlist$(comma)osfmk/mach/vm_statistics}.h \
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/Kernel/kern, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /osfmk/kern/ledger.h)
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /osfmk/kern/ledger.h)
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/Kernel/IOKit, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /iokit/IOKit/IOKitDebug.h)
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /iokit/IOKit/IOKitDebug.h)
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/Kernel/libkern, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /libkern/libkern/OSKextLibPrivate.h)
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /libkern/libkern/OSKextLibPrivate.h)
		https://github.com/apple-oss-distributions/xnu/raw/xnu-8792.81.2/libkern/libkern/OSKextLibPrivate.h)
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /libkern/libkern/OSKextLibPrivate.h)
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /libkern/libkern/OSKextLibPrivate.h)

	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/kern,https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /osfmk/kern/debug.h)
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/kern,https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /osfmk/kern/debug.h)
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/arm, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /{bsd/arm/disklabel$(comma)osfmk/arm/cpu_capabilities}.h)
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /{bsd/arm/disklabel$(comma)osfmk/arm/cpu_capabilities}.h)
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/machine, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /bsd/machine/disklabel.h)
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /bsd/machine/disklabel.h)
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/os, \
		...
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /libkern/os/{base_private$(comma)log_private$(comma)log}.h)
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /libkern/os/{base_private$(comma)log_private$(comma)log}.h)
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/bsm, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /bsd/bsm/audit_kevents.h)
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /bsd/bsm/audit_kevents.h)
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/machine, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /osfmk/machine/cpu_capabilities.h)
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /osfmk/machine/cpu_capabilities.h)
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/firehose, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /libkern/firehose/{tracepoint$(comma)firehose_types}_private.h)
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /libkern/firehose/{tracepoint$(comma)firehose_types}_private.h)
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/libkern, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 //libkern/libkern/{OSKextLibPrivate$(comma)mkext$(comma)prelink}.h)
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 //libkern/libkern/{OSKextLibPrivate$(comma)mkext$(comma)prelink}.h)
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/mach, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /osfmk/mach/coalition.h)
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /osfmk/mach/coalition.h)
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/firehose, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /libkern/firehose/tracepoint_private.h \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /libkern/firehose/firehose_types_private.h)
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /libkern/firehose/tracepoint_private.h \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /libkern/firehose/firehose_types_private.h)
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/sys, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /bsd/sys/{fcntl$(comma)fsctl$(comma)spawn_internal$(comma)resource$(comma)event$(comma)kdebug$(comma)proc$(comma)proc_info$(comma)pgo$(comma)proc_uuid_policy$(comma)acct$(comma)stackshot$(comma)event$(comma)mbuf$(comma)kern_memorystatus$(comma)reason}.h)
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /bsd/sys/{fcntl$(comma)fsctl$(comma)spawn_internal$(comma)resource$(comma)event$(comma)kdebug$(comma)proc$(comma)proc_info$(comma)pgo$(comma)proc_uuid_policy$(comma)acct$(comma)stackshot$(comma)event$(comma)mbuf$(comma)kern_memorystatus$(comma)reason}.h)
...
ifeq (,$(findstring darwin,$(MEMO_TARGET)))
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/sys, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /bsd/sys/resource.h \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-3789.1.32 /bsd/sys/resource.h \
